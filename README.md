...
A small RPG Maker-like engine that compiles out to the DS(i).

## Requirements:

* Python 3 latest with PIL, tkinter.
...
Read the DOCUMENTATION.md file to learn more about the engine.
